...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "DELETE FROM datamahasiswa WHERE id = $delete_id";
...
<div class="result-container" style="top:35%;">
        <h2>Data Mahasiswa Telah Dihapus</h2>
        <p>Informasi data mahasiswa yang telah dihapus:</p>
        <ul>
        <li style="margin-left:20px;"><strong>ID:</strong> <?php echo $delete_id; ?></li>
        </ul>
